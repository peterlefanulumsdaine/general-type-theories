...
Section Signature_Maps.
  ...
  Definition Fmap_Raw_Context {Σ Σ' : signature σ} (f : Signature.map Σ Σ')
  ...
  Definition Fmap_Hyp_Judgt_Bdry_Instance {Σ Σ' : signature σ} (f : Signature.map Σ Σ')
      {hjf} {γ}
  ...
  Definition Fmap_Hyp_Judgt_Form_Instance {Σ Σ' : signature σ} (f : Signature.map Σ Σ')
      {hjf} {γ}
  ...
  Definition Fmap_Judgt_Form_Instance {Σ Σ' : signature σ} (f : Signature.map Σ Σ')
      {jf}
  ...
  Definition Fmap_Judgt_Instance {Σ Σ' : signature σ} (f : Signature.map Σ Σ')
  ...
  Definition Fmap_Metavariable_Extension
    ...
    : Signature.map (Metavariable.extend Σ a)
  ...
  Definition Fmap_Flat_Rule {Σ Σ' : signature σ} (f : Signature.map Σ Σ')
