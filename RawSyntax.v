...
Record ProtoCxtSystem :=
  ...
  ; _ : forall γ δ : ProtoCxt, is_extend_by_1 (vars (protocxt_extend γ)) (vars γ)
  }.
...
Section Raw_Syntax.
  ...
  : Syn_Class -> PCxt -> Type
    ...
    | symb_raw (γ : PCxt) (S : Symbol Σ)
               (args : forall (i : arity _ S),
                   Raw_Syntax Σ (fst (arity _ S i))
                                (protocxt_coprod _ γ (snd (arity _ S i))))
      : Raw_Syntax Σ (class _ S) γ.
(* TODO : make arguments to [arity], [protocxt_coprod], and [class] implicit. *)
